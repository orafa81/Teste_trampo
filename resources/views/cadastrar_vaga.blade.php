            ...
            <h2 class="text-xl">Cadastro de Vagas</h1>
                <div class="mt-6 -mx-3 md:flex mb-6">
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            id="grid-first-name" type="text" placeholder="Senior" name="titulo" value="">
                ...
                <div class="mt-6 -mx-3 md:flex mb-6">
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-gray-500 rounded py-3 px-4 mb-3"
                            id="grid-first-name" type="text" placeholder="Senior" name="area" value="">
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-gray-500 rounded py-3 px-4 mb-3"
                            id="grid-first-name" type="text" placeholder="Senior" name="hierarquia" value="">
                        <p class="text-red text-xs italic"></p>
                    </div>
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-gray-500 rounded py-3 px-4 mb-3"
                            id="grid-first-name" type="text" placeholder="Senior" name="salario" value="">
                        <p class="text-red text-xs italic"></p>
                    </div>
                </div>
                            ...
                            <div class="-mx-3 md:flex mb-6">
                                <div class="md:w-full px-3">
                                    ...
                                    <input
                                        class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-gray-500 rounded py-3 px-4 mb-3"
                                        id="grid-password" type="text" placeholder="Atributo"
                                        name="atributoExists[{{ $atributo->id }}][]" value="{{ $atributo->titulo }}">
                                    <p class="text-grey-dark text-xs italic">Make it as long and as crazy as you'd like
                                    </p>
                                </div>
                            </div>
