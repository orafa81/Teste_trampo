        ...
        <div class="w-full py-8 bg-gray-50">
            ...
            <div class=" max-w-screen-xl flex flex-nowrap items-center gap-4 justify-start mx-auto">
                ...
                <div
                    ...
                    <a href="#">
                        <img class="rounded-t-lg" src="{{ asset('imagens/LogoEmpresa1.png') }}" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                        ...
                        <a href="#"
                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-violet-900 rounded-lg hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-violet-300 ">
                            Read more
